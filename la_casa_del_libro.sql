...
CREATE TABLE `genero` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `genero_tipo` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
--
-- Estructura de tabla para la tabla `pivotxgeneroxlibro`
--

CREATE TABLE `pivotxgeneroxlibro` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pivotxgeneroxlibro`
--

INSERT INTO `pivotxgeneroxlibro` (`id`, `genero_id`, `libro_id`) VALUES
(1, 1, 1),
(2, 3, 1),
(3, 3, 9),
(4, 2, 9),
...
--
-- Indices de la tabla `pivotxgeneroxlibro`
--
...
--
-- Filtros para la tabla `pivotxgeneroxlibro`
--
ALTER TABLE `pivotxgeneroxlibro`
