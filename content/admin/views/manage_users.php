...
<div class="container-xxl mx-auto container-fluid row my-5">
    <div>
        ...
        <div class="row mb-5 d-flex align-items-center justify-content-center">
                ...
                <tbody>
                    <?php foreach ($users as $user) { ?>
                        <tr>
                            ...
                            <td class="col-lg-5 col-md-4 col-8">compras</td>
                            
                            <td class="col-lg-2 col-md-2 col-2">
                                <a href="index.php?view=edit_user&id=<?= htmlspecialchars($user->getId()) ?>" class="d-block btn btn-sm btn-warning .btn-escalante-edit mb-1">Editar</a>
            ...
            <a style="max-width:50%!important;" href="index.php?view=add_user" class="btn btn-primary mt-5">Agregar usuario</a>
        </div>
    </div>
</div>